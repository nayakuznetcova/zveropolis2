...
//
//        // Действие
//        reportDogMenu.textAndPhoto(update);
//
...
//        Long chatId = 123L;
//
//        reportDogMenu reportDogMenu = new reportDogMenu(mock(SubscriberRepository.class), mock(Relocation.class), mock(TelegramBotSendMessage.class),
